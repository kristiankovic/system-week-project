...
<body data-bs-theme="dark"">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        <li class="nav-item">
            <a href="/mvc/public" class="nav-link active" aria-current="page">
                Inicio
            </a>
        </li>
        <li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-xl-9">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Mi nombre es Cristian Alexis Ventura Ventura, actualmente estoy cursando el segundo ciclo del tercer año de Universidad.</p>
                                <p class="card-text">Este trabajo esta orientado a mostrar todas las actividades de la Semana de Sistemas 2025, desde su inaguración hasta su cierre,
                                ...
                                <p class="card-text">Espero que la información y todo lo presentado en este blog sirva de guía para poder hacer un
                                ...
                                <div class="row pt-4">
                                    ...
                                    <div class="col-lg-3 col-sm-6">
                                        <div class="pt-3 d-flex flex-column align-items-center ">
                                            ...
                                            <a class="pt-2" href="https://www.reddit.com/user/insolennte/" target="_blank" class="">Reddit</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-sm-6">
                                        <div class="pt-3 d-flex flex-column align-items-center">
                                            ...
                                            <a class="pt-2" href="https://github.com/kristiankovic?tab=repositories" target="_blank" class="">Github</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-sm-6">
                                        <div class="pt-3 d-flex flex-column align-items-center">
                                            ...
                                            <a class="pt-2" href="#" target="_blank" class="">Facebook</a>
                                        </div>
                                    </div>
